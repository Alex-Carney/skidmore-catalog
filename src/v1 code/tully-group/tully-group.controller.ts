...
import { FieldSelectDTO, QueryParamDTO, TullyGroupFields, } from 'src/v1 code/tully-group-resolvers/dto/tully-group.dto';
...
//this controller handles HTTP requests for tully-group-resolvers data

//TODO: Move ApiTags up here (and auth?)

@UseGuards(JwtAuthGuard)
@ApiBearerAuth()
@Controller('tully-group-resolvers')
export class TullyGroupController {
    //inject the tully-group-resolvers service class, which holds the actual logic for querying from the database
