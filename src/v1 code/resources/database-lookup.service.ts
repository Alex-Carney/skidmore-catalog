 ...
 * (like we have for tully-group-resolvers with tully-group-resolvers.service), we can define a scaffold for a dynamic provider/service. We can configure a new
